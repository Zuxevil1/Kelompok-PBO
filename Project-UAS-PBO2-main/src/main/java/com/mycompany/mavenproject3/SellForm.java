...
public class SellForm extends JFrame {
    ...
    private void updateInfo() {
        ...
        if (selectedProduct != null && selectedUnit != null) {
            ...
            double pricePerUnit = selectedProduct.getOriginalPrice() * selectedUnit.getJumlah();
